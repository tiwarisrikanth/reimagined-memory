...
class PeacePage extends StatefulWidget {
  const PeacePage({Key? key}) : super(key: key);

  @override
  _PeacePageState createState() => _PeacePageState();
}
...
class _PeacePageState extends State<PeacePage> {
  Future getGeneralData() async {
    final response = await http.get(
      Uri.parse(
        "https://goquotes-api.herokuapp.com/api/v1/all?type=tag&val=peace",
      ),
    );
